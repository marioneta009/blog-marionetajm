<template>
  <div class="content-wrapper bg-background-primary font-sans text-copy-primary leading-normal flex flex-col min-h-screen" :class="theme">
    <header class="border-t-14 border-gray-900">
      <nav class="container mx-auto flex flex-wrap justify-between items-center py-8 px-12">
        <div>
        ...
        >
          ...
          <li>
            <a v-if="$route.path === '/'" href="/" v-scroll-to="'#projects'" class="text-copy-primary hover:text-gray-600">Inicio</a>
            <g-link v-else to="/#projects" class="text-copy-primary hover:text-gray-600">Inicio</g-link>
          </li>
          <li>
    ...
    <footer class="bg-gray-900 text-white">
      <div class="container mx-auto flex flex-col lg:flex-row items-center justify-between py-8">
        <div class="mb-8 lg:mb-0">
          <div>Copyright {{ new Date().getFullYear() }}. All rights reserved. Made with love by Marioneta JM</div>
          <div>
